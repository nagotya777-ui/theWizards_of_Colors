...
function getContrastTextColor(hexColor) {
    ...
    // If lightness is greater than 65, use dark text; otherwise use light text
    return hsl.l > 65 ? '#2c2c2c' : '#ffffff';
}
...
function getAdjustedButtonColor(backgroundColorCode) {
    ...
    // If background is light (lightness > 65), darken the button color
    if (hsl.l > 65) {
